...
It also misses an upturn in 2016. The following is comparison of AICs for the four models.
```{r}
...
```
Although, the cubic periodic spline has only three free parameters fully 
determined by the first three derivatives on the left of 0, the third 
derivative is not continuous as the following plot of derivatives shows.
```{r}
