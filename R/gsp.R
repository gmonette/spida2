...
#' function \code{\link{sc}} helps in the construction of linear hypothesis matrices
...
#' @seealso \code{\link{wald}} \code{\link{sc}}
...
#' in \code{\link{gsp}}.
#' 
#' @param sp a spline function generated by \code{\link{gsp}}
...
#' @seealso \code{\link{wald}} \code{\link{gsp}}
#' @export
sc <-
